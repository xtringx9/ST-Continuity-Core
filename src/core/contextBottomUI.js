            ...
            if (isUseContainer) {
                ...
                if (contentContainer) {
                    if (moduleData.containerStyles) {
                        ...
                        // 添加处理后的模块数据
                        const moduleContent = `<details class="module-data" style="white-space: pre-wrap;max-height: 200px;"><summary>${moduleConfig.displayName || moduleConfig.name} (${moduleData.moduleCount})</summary>${moduleStrings}</details>`;
